...
def left(a, b):
	# print(grid[a][b], grid[a][b-1], grid[a][b-2], grid[a][b-3])
	return grid[a][b]*grid[a][b-1]*grid[a][b-2]*grid[a][b-3]

def up(a, b):
	# print(grid[a][b], grid[a-1][b], grid[a-2][b], grid[a-3][b])
...
def diaLU(a, b):
	# print(grid[a][b], grid[a-1][b-1], grid[a-2][b-2], grid[a-3][b-3])
...
for i in range(3, 20-3):
	for j in range(3, 20-3):
		...
		if maxProductCurrent>maxProduct:
			maxProduct = maxProductCurrent
